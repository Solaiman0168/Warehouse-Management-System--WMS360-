                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box screen-option-content" style="display: none">
                            ...
                            <div class="row content-inner mt-2 mb-2">
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="image" class="onoffswitch-checkbox" id="image" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['image']) && $setting['shopify']['shopify_active_product']['image'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['image']) && $setting['shopify']['shopify_active_product']['image'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="item-id" class="onoffswitch-checkbox" id="item-id" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['item-id']) && $setting['shopify']['shopify_active_product']['item-id'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['item-id']) && $setting['shopify']['shopify_active_product']['item-id'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="collection" class="onoffswitch-checkbox" id="collection" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['collection']) && $setting['shopify']['shopify_active_product']['collection'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['collection']) && $setting['shopify']['shopify_active_product']['collection'] == 0) @else checked @endif>
                                            <label class="onoffswitch-label" for="collection">
                                                <span class="onoffswitch-inner"></span>
                                                <span class="onoffswitch-switch"></span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="account" class="onoffswitch-checkbox" id="account" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['account']) && $setting['shopify']['shopify_active_product']['account'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['account']) && $setting['shopify']['shopify_active_product']['account'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="product-name" class="onoffswitch-checkbox" id="product-name" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['product-name']) && $setting['shopify']['shopify_active_product']['product-name'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['product-name']) && $setting['shopify']['shopify_active_product']['product-name'] == 0) @else checked @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center mt-sm-10">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="stock" class="onoffswitch-checkbox" id="stock" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['stock']) && $setting['shopify']['shopify_active_product']['stock'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['stock']) && $setting['shopify']['shopify_active_product']['stock'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="status" class="onoffswitch-checkbox" id="status" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['status']) && $setting['shopify']['shopify_active_product']['status'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['status']) && $setting['shopify']['shopify_active_product']['status'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="modifier" class="onoffswitch-checkbox" id="modifier" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['modifier']) && $setting['shopify']['shopify_active_product']['modifier'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['modifier']) && $setting['shopify']['shopify_active_product']['modifier'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="sku" class="onoffswitch-checkbox" id="sku" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['sku']) && $setting['shopify']['shopify_active_product']['sku'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['sku']) && $setting['shopify']['shopify_active_product']['sku'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="qr" class="onoffswitch-checkbox" id="qr" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['qr']) && $setting['shopify']['shopify_active_product']['qr'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['qr']) && $setting['shopify']['shopify_active_product']['qr'] == 0) @else checked @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center mt-sm-10">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="variation" class="onoffswitch-checkbox" id="variation" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['variation']) && $setting['shopify']['shopify_active_product']['variation'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['variation']) && $setting['shopify']['shopify_active_product']['variation'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="regular-price" class="onoffswitch-checkbox" id="regular-price" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['regular-price']) && $setting['shopify']['shopify_active_product']['regular-price'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['regular-price']) && $setting['shopify']['shopify_active_product']['regular-price'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="sales-price" class="onoffswitch-checkbox" id="sales-price" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['sales-price']) && $setting['shopify']['shopify_active_product']['sales-price'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['sales-price']) && $setting['shopify']['shopify_active_product']['sales-price'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="sold" class="onoffswitch-checkbox" id="sold" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['sold']) && $setting['shopify']['shopify_active_product']['sold'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['sold']) && $setting['shopify']['shopify_active_product']['sold'] == 0) @else checked @endif>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="available-qty" class="onoffswitch-checkbox" id="available-qty" tabindex="0" @if(isset($setting['shopify']['shopify_active_product']['available-qty']) && $setting['shopify']['shopify_active_product']['available-qty'] == 1) checked @elseif(isset($setting['shopify']['shopify_active_product']['available-qty']) && $setting['shopify']['shopify_active_product']['available-qty'] == 0) @else checked @endif>
                            ...
                            <input type="hidden" id="secondKey" value="shopify_active_product">
                        ...
                        <form action="{{asset('generate-csv-comparing-live-data')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="upload-csv-in-unmatched-list">
                                ...
                                <div class="custom-file mr-1">
                                    ...
                                    <input type="hidden" class="" name="channel_column" value="Shopify Quantity">
                        ...
                        <!--End Backend error handler-->
                            ...
                            <table class="ebay-table w-100 mytable" id="testTable">
                                ...
                                <tr>
                                    ...
                                    <th class="collection" style="width: 6% !important; vertical-align:top;">
                                    ...
                                    <th class="product-name" style="width: 10%; vertical-align:top;">
                                        <div class="d-flex justify-content-start">
                                            <div class="btn-group">
                                                <a type="button" class="dropdown-toggle filter-btn" data-toggle="dropdown">
                                                    <a type="button" class="dropdown-toggle filter-btn" data-toggle="dropdown">
...
{{--                                </td>--}}
                                <td class="image" style="cursor: pointer; width: 6% !important; text-align: center !important" data-toggle="collapse" id="mtr-{{$product_list->id}}" onclick="getVariation(this)" data-target="#demo{{$product_list->id}}" class="accordion-toggle">
                                    ...
                                    @if(isset( \Opis\Closure\unserialize($product_list->image)[0]['src']))
                                        <a href="{{\Opis\Closure\unserialize($product_list->image)[0]['src']}}"  title="Click to expand" target="_blank"><img src="{{\Opis\Closure\unserialize($product_list->image)[0]['src']}}" class="ebay-image zoom" alt="ebay-master-image"></a>
                                    @else
                                ...
                                @php
                                if(@unserialize($product_list->product_type) !== FALSE) {
                                    $shopify_collection = \App\shopify\ShopifyCollection::where('shopify_collection_id', explode('/',\Opis\Closure\unserialize($product_list->product_type)[0] ?? '')[1] ?? null)->first();
                                    $shopify_variant = \App\shopify\ShopifyVariation::where('shopify_master_product_id', $product_list->id)->get();
                                }
                                @endphp
                                <td class="product-name" style="cursor: pointer; width: 20%" data-toggle="collapse" id="mtr-{{$product_list->id}}" data-target="#demo{{$product_list->id}}" onclick="getVariation(this)" class="accordion-toggle" data-toggle="tooltip" data-placement="top" title="{{$product_list->title}}">
                                    <a class="ebay-product-name" href="{{ 'https://dieseloutletshop.co.uk/collections/'.strtolower(str_replace(' ','-',$shopify_collection->category_name ?? '')).'/products/'.strtolower(str_replace(' ','-',$product_list->title)).'?variant='.($shopify_variant[0]->shopify_variant_it ?? '') }}" target="_blank">
                                ...
                                @endphp
                                <td class="stock text-center" style="cursor: pointer; text-align: center !important; width: 5%" data-toggle="collapse" data-target="#demo{{$product_list->id}}" id="mtr-{{$product_list->id}}" onclick="getVariation(this)" class="accordion-toggle">{{$total_quantity}}
                                </td>
                                <td class="status text-center" style="cursor: pointer; width: 8%" data-toggle="collapse" id="mtr-{{$product_list->id}}" data-target="#demo{{$product_list->id}}" onclick="getVariation(this)" class="accordion-toggle" data-toggle="tooltip" data-placement="top">
                                        {{$product_list->status}}
                                </td>
